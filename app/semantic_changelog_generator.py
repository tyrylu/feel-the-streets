...
def get_dictchange_description(dictchange, entity_fields):
    ...
    if dictchange.kind is CT.Create:
    ...
    elif dictchange.kind is CT.Update:
    ...
    elif dictchange.kind is CT.Remove:
